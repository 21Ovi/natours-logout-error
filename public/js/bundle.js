...
function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoib3Zlc2giLCJhIjoiY2t5MTUzc25yMDM5cjJ1bGpheXd5YWF4NiJ9.qEIvrX66C9owo5Fa4Q13gw';
  ...
  locations.forEach(function (loc) {
    ...
    el.className = 'marker'; // add marker to the map
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // extend the map bounds to include the current location
